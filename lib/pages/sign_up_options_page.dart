...
class SignUpOptionsPage extends ConsumerStatefulWidget {
  const SignUpOptionsPage({super.key});

  @override
  ConsumerState<SignUpOptionsPage> createState() => _SignUpOptionsPageState();
}

class _SignUpOptionsPageState extends ConsumerState<SignUpOptionsPage> {
        ...
        AuthOptionsPage(
          ...
          onFooterTap: () {
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (_) => const LoginOptionsPage()),
            );
          },
        ),
